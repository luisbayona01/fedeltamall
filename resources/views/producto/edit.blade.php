    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="card card-default">
                ...
                <div class="card-body">
                    <form method="POST" action="{{url('/updateproductos') }}"  role="form" enctype="multipart/form-data">
                               ...
                               @if(is_null( session('iduseradmintienda')  ))
                                ...
                                <div class="form-group">
                                  ...
                                  <select class="form-control" name="idtienda">
                                    ...
                                    @foreach ($tienda as $tienda)
                                      @if($tienda->idtiendas==$producto->idtienda )
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="idcategoria">
                                      ...
                                      @if($categoriaproducto->idcategoria  == $producto->idcategoria)
                                        <option value="{{$categoriaproducto->idcategoria}}" selected>{{$categoriaproducto->categoria}} </option>
                                       @endif
